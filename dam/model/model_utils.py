...
def load_pretrained_model(
    ...
    **kwargs,
    ...
    if context_provider is not None and device != "cpu":
        context_provider.to(device=device, dtype=dtype)
...
def prepare_config_for_eval(config: PretrainedConfig, kwargs: dict):
    ...
    if "siglip" in vision_tower_name.lower() and torch.cuda.is_available():
