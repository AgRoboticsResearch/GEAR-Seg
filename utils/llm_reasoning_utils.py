...
# Prompt
# ------------------------------------------------
def build_reasonseg_prompt(question, whole_desc, mask_desc):
...
Reasoning Steps:
1. Understand the whole scene.
2. Use commonsense reasoning.
3. Select masks referring to the SAME object category.
4. Return at most 6 masks.
